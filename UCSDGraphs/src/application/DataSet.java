...
public class DataSet {
    ...
    private HashMap<geography.GeographicPoint,HashSet<geography.Edge>>  roads;
    ...
    public void setRoads(HashMap<geography.GeographicPoint,HashSet<geography.Edge>>  roads) { this.roads = roads; }
    ...
    public HashMap<geography.GeographicPoint,HashSet<geography.Edge>>  getRoads() { return this.roads; }

    public void initializeGraph() {
        graph = new roadgraph.MapGraph();
        roads = new HashMap<geography.GeographicPoint, HashSet<geography.Edge>>();
