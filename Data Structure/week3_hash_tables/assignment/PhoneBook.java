...
public class PhoneBook {
    ...
    private String[] nameBook = new String[10000000];
    ...
    private void processQueryFast(Query query){
        ...
        if (query.type.equals("add")){
            nameBook[query.number] = query.name;
        } else if (query.type.equals("del")){
            nameBook[query.number] = null;
        } else {
            String response = "not found";
            if(nameBook[query.number] != null){
                response = nameBook[query.number];
            }
            writeResponse(response);
        } 
    }
